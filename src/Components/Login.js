...
import { Typography, Button, Dialog, DialogActions, DialogContent, DialogTitle, Divider, Box, Paper } from "@mui/material";
  ...
  return (
    <Box sx={{ minHeight: "100vh", bgcolor: "#fff" }}>
      <Box sx={{ py: 2, display: "flex", flexDirection: "column", alignItems: "center" }}>
        <Link to="/">
          <img src={amazonLogo} alt="" style={{ width: "8.2rem", height: "2.6rem" }} />
        </Link>
        <Paper
          elevation={2}
          sx={{
        ...
        >
          <Typography sx={{ fontSize: "2rem", mb: 2 }}>Sign in</Typography>
          <form id="form" style={{ width: "100%" }}>
            <Typography sx={{ fontWeight: "bold", fontSize: "0.85rem", letterSpacing: "0.05rem" }}>
        ...
        <Divider sx={{ width: "23rem", fontSize: "0.8rem", color: "#767676", my: 2 }}>
          New to Amazon?
        </Divider>
      ...
      >
        <Box sx={{ width: "20%", display: "flex", justifyContent: "space-around" }}>
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            style={{ color: "#0066C0", fontSize: "0.8rem", textDecoration: "none" }}
          >
            Conditions of Use
          </a>
          <a
